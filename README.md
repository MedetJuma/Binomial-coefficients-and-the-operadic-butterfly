This is the addendum to the paper "Binomial coefficients and the operadic butterfly" by Vladimir Dotsenko and Medet Jumadildayev.
...
Consider an operad $\mathcal X^+$ with an adjoined binary operation $\lambda$. The induction verification procedure files from Section 4 of the paper are contained in [Verification_Xplus](./Verification_Xplus/):
